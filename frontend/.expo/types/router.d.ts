  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | { pathname: `/RegConsumidor`; params?: Router.UnknownInputParams }
        | { pathname: `/RegNegocio`; params?: Router.UnknownInputParams }
      ...
      hrefOutputParams:
        ...
        | { pathname: `/Perfil`; params?: Router.UnknownOutputParams }
        | { pathname: `/RegConsumidor`; params?: Router.UnknownOutputParams }
        | { pathname: `/RegNegocio`; params?: Router.UnknownOutputParams }
        | { pathname: `/Registro`; params?: Router.UnknownOutputParams }
      ...
      href:
        ...
        | `/RegConsumidor${`?${string}` | `#${string}` | ''}`
        | `/RegNegocio${`?${string}` | `#${string}` | ''}`
