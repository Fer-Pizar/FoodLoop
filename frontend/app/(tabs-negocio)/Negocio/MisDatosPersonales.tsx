...
export default function MisDatosPersonales() {
  ...
  if (error || !data) {
    return (
      ...
      >
        <TBold style={{ marginBottom: 8 }}>
          No se pudo cargar el perfil 😵
        </TBold>
        <T style={{ opacity: 0.7, textAlign: "center" }}>
          {error ?? "Sin datos"}
        </T>
      </View>
    );
    ...
    >
      ...
      <View style={{ padding: 16, alignItems: "center", marginTop: 20 }}>
        <TouchableOpacity
          ...
          style={{
            backgroundColor: !hasChanges || saving ? "rgba(207, 0, 31, 1)" : RED,
            paddingVertical: 14,
        ...
        >
          <TBold style={{ color: "#fff", fontFamily: FONT_BOLD }}>
