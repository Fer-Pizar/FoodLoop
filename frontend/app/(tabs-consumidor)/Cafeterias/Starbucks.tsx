...
import { SafeAreaView, View, Text, TextInput, StyleSheet, ScrollView, FlatList, Image, TouchableOpacity, Dimensions, ActivityIndicator,} from "react-native";
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <View style={styles.body}>
            ...
            <FlatList
              ...
              scrollEnabled={false}
              renderItem={({ item }) => (
                <ProductCard product={item} colors={colors} isDark={isDark} />
              )}
            />
          </View>
        </ScrollView>
      ...
      <View style={{ paddingHorizontal: 12, paddingTop: 8, paddingBottom: 12 }}>
        ...
        <View style={[styles.rowBetween, { marginTop: 10 }]}>
          <View style={styles.row}>
            ...
            {product.oldPrice ? (
              <Text style={[styles.oldPrice, { color: GRAY_TEXT }]}>
                {" "}
                Bs. {product.oldPrice}
              </Text>
            ) : null}
          ...
          <TouchableOpacity
            style={[styles.addBtn, { backgroundColor: "#2A6A5A" }]}
          >
